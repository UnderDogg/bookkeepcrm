...
class ContentsHtmlBuilder
{
    ...
    {
        return action_button(route('bookkeeper.' . $key . '.index'), 'icon-arrow-left', trans($key . '.all'), 'button--emphasis', 'l');
    }
